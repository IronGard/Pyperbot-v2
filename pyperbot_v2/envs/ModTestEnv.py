...
class ModTestEnv(gym.Env):
    ...
    def get_dist_to_goal(self):
        ...
        '''
        return math.hypot(self._goal.get_goals()[0][0] - self._snake.get_base_observation()[0][0], self._goal.get_goals()[0][1] - self._snake.get_base_observation()[0][1])
    ...
    def reset(self, seed = None):
        ...
        self._snake = Snakebot(self._client)
        ...
        #step once before getting observations
